...
async function populate() {
  ...
  // if (User) await User.destroy({ where: {}, truncate: true });
  // if (Type) await Type.destroy({ where: {}, truncate: true });
  // if (Project) await Project.destroy({ where: {}, truncate: true });
